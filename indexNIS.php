<?php
require_once '../Controlador/ControladorNIS.php';
...
<body>
    ...
    <form method="POST" action="">
        ...
        Número de Mesathth: <input type="number" name="NumeroMesa" required value="<?php echo $editar ? $registroActual['NumeroMesa'] : ''; ?>">
        <br>
